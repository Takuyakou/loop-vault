...
const rootMotionHistoryEntrySchema: z.ZodType<RootMotionHistoryEntry> = z.object({
  ...
  motions: z.array(z.object({ signedSemitones: rootMotionSignedSemitoneSchema, direction: z.enum(["same", "up", "down"]), category: z.enum(["same", "second", "third", "fourth", "tritone", "fifth"]) }).strict()).min(1).max(7),
